...
export class Migration1725947415194 implements MigrationInterface {
    name = 'Migration1725947415194'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "board" ("boardNo" SERIAL NOT NULL, "userId" character varying NOT NULL, "title" character varying NOT NULL, "contents" character varying NOT NULL, "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "createAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_72f2437f2d1a0cfe91ae4120f0f" PRIMARY KEY ("boardNo"))`);
